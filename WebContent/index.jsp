...
<div id="header">
  <div id="menu">
    <ul>
      <li class="current_page_item"><a href="index.jsp">Trang chủ</a></li>
...
<div id="page">
  <div id="content">
    <div class="post">
      <h1 class="title"><a href="#">About this Website</a></h1>
      <p>Trang web này tạo ra nhằm mục đích quản lý và kiểm soát những người đi qua tại một chốt kiểm dịch để có thể xác định tìm kiếm thông tin khi ai đó bị nhiễm bệnh</p>
      <div class="entry"></div>
    </div>
  </div>
</div>
