  		...
  		<div id="content">
		    <div class="post">
		      <h1>Thông tin </h1>
				...
				<div>Quốc tịch</div>
				<form:input path="nationality" value="${PersonalInfor.Nationalty }"/>
				...
				<form:option value="Name" label="Nam"/>
				...
				<div>Phương tiện</div>
				<select class="form-control valid" name="fields[vehicle]" aria-required="true" aria-invalid="false"> 
